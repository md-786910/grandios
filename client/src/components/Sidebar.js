...
const Sidebar = ({ isOpen, onClose = () => {} }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-100 flex flex-col z-50 transform transition-transform duration-300 md:translate-x-0 ${
